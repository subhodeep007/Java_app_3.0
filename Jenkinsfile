...
pipeline{
    ...
    parameters{
        ...
        string(name: 'ImageName', description: "name of the docker build", defaultValue: 'javapp1')
        string(name: 'ImageTag', description: "tag of the docker build", defaultValue: 'v1')
        string(name: 'DockerHubUser', description: "name of the Application", defaultValue: 'subhodeepdas777')
    }
